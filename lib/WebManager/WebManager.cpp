...
#include "../../include/WebPage.h" // Aponta para a pasta include do PlatformIO
...
void WebManager::setupRoutes() {
  ...
  server.on("/pause", [this](){ this->experimento->pause(this->relogio->getUnixAgora()); server.send(200, "text/plain", "OK"); });
  server.on("/resume", [this](){ this->experimento->resume(this->relogio->getUnixAgora()); server.send(200, "text/plain", "OK"); });
