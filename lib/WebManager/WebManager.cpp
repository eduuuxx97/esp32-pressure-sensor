...
// Busca o arquivo na pasta include do PlatformIO sem precisar movê-lo
...
void WebManager::setupRoutes() {
  ...
  server.on("/dados", [this](){
      ...
      // Verifica saúde dos periféricos para os LEDs da interface
      bool sdOk = (SD.cardType() != CARD_NONE); 
      bool adsOk = this->sensores->isHardwareOK();
      ...
      json += ", \"adsStatus\": " + String(adsOk ? "true" : "false"); 
      json += "}";
